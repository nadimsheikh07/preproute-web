...
export default function CreateTestPage() {
    ...
    const onSubmit = async (
        ...
        try {
            ...
            const response = await api.post<ApiResponse<any>>("/tests", payload);

            if (!response.data.success) {
                throw new Error(response.data.message || "Unable to create test");
            }
            ...
            messageApi.error(
                error?.response?.data?.message || "Unable to save test",
            );
        } finally {
            setSaving(false);
        }
    ...
    const handleNext = handleSubmit((values) => onSubmit(values, null));
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 p-4 md:p-6">
                <div className="mx-auto max-w-6xl">
                    ...
                    <form onSubmit={handleSubmit((values) => onSubmit(values, null))}>
                        {/* Basic Details */}
                        <Card
